...
function preload() {
  backgroundImg = loadImage("MarinaSndWar.jpg");
  ...
  towerImage = loadImage("Destructor.png");
  boatSpritedata = loadJSON("boat.json");
  boatSpritesheet = loadImage("AcorazadoAlemanSp.png");
  brokenBoatSpritedata = loadJSON("broken_boat.json");
  brokenBoatSpritesheet = loadImage("AcorazadoBroken.png");
...
function setup() {
  ...
  tower = Bodies.rectangle(160, 340, 160, 310, { isStatic: true });
  World.add(world, tower);

  cannon = new Cannon(180, 365, 100, 50, angle);
  ...
  swal(
    {
      ...
      imageUrl:
        "https://lagrieta.github.io/FinDeCursoCarlos/",
      imageSize: "150x150",
